...
function App() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      setUser(currentUser);
      setLoading(false); // Auth initialized
    });
      ...
      <>
        ...
        { user ? (
          <>
            <>
              <h1>Apple Store</h1>
              <p>We sell actual Apples. Not Phones. I repeat, Not Phones. If that's what your looking for please go somewhere else.</p>
              <p>Apples are tasty and healthy. Please buy our great apples provided below.</p>
